...
function setSlidePanels () {
	...
	createSwipe("newsContents", {data:mediaData}, "news", function(s, d, w){
	...
	createSwipe("contentsWrap", {data:contentData}, "contents", function(s, d, w){
	...
	createSwipe("funContents", {data:funData}, "fun", function(s, d, w){
	...
	createSwipe("issueContents", {data:issueData}, "issue", function(s, d, w){
